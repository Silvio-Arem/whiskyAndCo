...
export const products = [
  { id: 1, name: "Whiskey Woodford Reserve 750ml", category: "Tennessee Whiskey", picture: "", price: 185.91, description: "Woodford Reserve é um luxuoso bourbon, cuidadosamente produzido à mão em pequenos lotes na Woodford Reserve Distillery. Tradicional desde 1812, é a destilaria mais antiga dos Estados Unidos. Triplamente destilada e envelhecida sob medida ao longo do tempo em barris de carvalho branco americano. É o unico bourbon do mundo a ter barris criados especificamente para sua produção. O mashbill para Woodford Reserve apresenta uma elevada porcentagem de centeio: 72% do milho, 18% de centeio e 10% de malte." },
  { id: 2, name: "Whisky Suntory Hibiki Harmony 700ml", category: "Whisky Japonês", picture: "", price: 632.31, description: "Luminoso, delicado, de uma transparência que revela complexidade. O Whisky Hibiki Harmony é uma bebida leve com notas de cascas de laranja e chocolate branco que ajuda a torná-lo um whisky sedutor. Ele é formado por grãos e maltes do Japão que ajuda a fazer dele uma bebida que representa estações do país." },
  { id: 3, name: "Bourbon Maker's Mark 700ml", category: "Bourbon Whiskey", picture: "", price: 139.90, description: "O Bourbon Maker's Mark é uma bebida produzida em Loretto, Kentucky, nos Estados Unidos. É conhecido pelo seu processo de produção, que inclui a utilização de milho vermelho, cevada maltada e centeio em sua composição, além de ser envelhecido em barris de carvalho branco americano por seis anos." },
  { id: 4, name: "Bourbon Wild Turkey 101 1L", category: "Bourbon Whiskey", picture: "", price: 219.90, description: "O Bourbon Wild Turkey 101 é uma bebida produzida em Lawrenceburg, Kentucky, nos Estados Unidos. É conhecido pela sua alta graduação alcoólica, que chega a 50,5% em volume, e pelo seu sabor rico em notas de baunilha, caramelo e especiarias." },
  { id: 5, name: "Rye Whiskey Bulleit 750ml", category: "Rye", picture: "", price: 149.90, description: "O Rye Whiskey Bulleit é uma bebida produzida em Lawrenceburg, Kentucky, nos Estados Unidos. É conhecido pelo seu sabor marcante de centeio, que lhe confere notas picantes e terrosas, além de um final seco e persistente. É envelhecido por no mínimo quatro anos em barris de carvalho branco americano." },
];
